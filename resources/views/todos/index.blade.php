@extends('layouts.app')
    ...
    <!-- THis $todos is the todos key that we have identified in with function in TodosController and
    its value can be accessed by putting todos in double curly braces. -->
